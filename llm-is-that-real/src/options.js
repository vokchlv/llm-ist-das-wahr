...
export const OptionsApp = () => {
    ...
    return (_jsxs("div", { style: {
            ...
            minHeight: '100vh'
                    ...
                    marginBottom: '20px'
                }, children: [_jsx("h2", { style: { fontSize: '18px', marginBottom: '5px' }, children: providers.find(p => p.id === selectedProvider)?.name }), selectedProvider === 'pollinations' && (_jsx("p", { style: { fontSize: '12px', color: '#666', marginBottom: '20px' }, children: "Pollinations.ai ist kostenlos und ben\u00F6tigt keinen API-Key." })), selectedProvider !== 'pollinations' && (_jsxs("div", { style: { marginBottom: '15px' }, children: [_jsx("label", { style: { display: 'block', marginBottom: '8px', fontWeight: '500', color: '#333', fontSize: '14px' }, children: "API-Key:" }), _jsx("input", { type: "password", value: apiKeys[selectedProvider]?.key || '', onChange: (e) => handleKeyChange(selectedProvider, e.target.value), placeholder: "Geben Sie hier Ihren API-Key ein.", style: {
                                    width: '100%',
                                    padding: '12px',
                            ...
                            fontSize: '12px',
                            color: '#333'
                        }, children: [selectedProvider === 'pollinations' && (_jsx("p", { children: "Das Modell von Pollinations.ai bietet zwar kostenlose Ergebnisse, jedoch kann hier keine zuverl\u00E4ssige Auswertung durchgef\u00FChrt werden." })), selectedProvider === 'openai' && (_jsx("p", { children: "Die Modelle von OpenAI sind bekannt f\u00FCr ihre hohe Qualit\u00E4t und Zuverl\u00E4ssigkeit. Im kostenlosen Tarif steht allerdings nur das Mini-Modell zur Verf\u00FCgung." })), selectedProvider === 'anthropic' && (_jsx("p", { children: "Anthropic Claude ist bekannt f\u00FCr hohe Qualit\u00E4t und zuverl\u00E4ssige Ergebnisse." })), selectedProvider === 'gemini' && (_jsx("p", { children: "Google Gemini ist bekannt f\u00FCr seine schnelle Verarbeitung und bietet kostenlose und zuverl\u00E4ssige API-Token zur Verwendung an." }))] })] }), _jsx("button", { onClick: handleSave, style: {
                    width: '100%',
                    padding: '14px',
                    background: '#4CAF50',
                    color: 'white',
